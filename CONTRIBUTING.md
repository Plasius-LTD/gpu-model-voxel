# Contributing to @plasius/gpu-model-voxel
...
`@plasius/gpu-model-voxel` compiles verified renderer-neutral static model
documents into deterministic PVOX artifacts, validates them independently,
renders CPU review evidence, and exposes browser-safe decoding helpers.

Contributions typically cover bounded binary codecs, voxelisation, validation,
reference traversal, review rendering, and compatibility-safe runtime helpers.
